...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnProceed.setBounds(230, 220, 100, 23);
        ...
        jLabel4.setBounds(150, 250, 180, 30);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       String image[]={"image1.png", "image2.png", "image3.png", "image4.png", "image5.png"};
        ...
        jLabel5.setIcon(new ImageIcon(image[i]));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       LoginForm loginPage = new LoginForm(); // Replace with your actual login page class name
    
    // Set the current frame (or window) to invisible, if desired
